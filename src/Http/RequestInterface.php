...
use Greg\Support\Accessor\ArrayAccessTraitInterface;

interface RequestInterface extends RequestStaticTraitInterface, ArrayAccessTraitInterface
{
    const URI_ALL = 'all';
    ...
    public function setAll(array $storage);
}
